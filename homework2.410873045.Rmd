...
```{r ans23}
# course_update2
course_update$course["teacher"]<-list("紀學檜老師")
...
```{r ans32}
# Pikachu_stats
Pikachu$`baseStats`[c(1,2,3)] -> Pikachu_stats
...
```{r ans33}
# Jigglypuff
Gamemaster$`pokemon`[[46]][[2]] <-"Jigglypuff"
...
```{r ans34}
# Gamemaster
Mimikyu<-list(dex=as.integer(778),
              speciesName="Mimikyu",
              speciesId="mimikyu",
              baseStats=Pikachu[[4]],
              types=c("ghost","fairy"),
